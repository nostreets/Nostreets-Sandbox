(function () {
    ...
    function _setUp() {
        ...
        vm.album.addClass("album--loaded");
        setTimeout(() => {
            vm.album.addClass("album--parallax");
        }, 1200);
    ...
    function _handlers() {
        ...
        //    });
        //});
        const buttons = $(".toggles button").on('click',
            () => {
                let theme = "";
    ...
    function _toggleThemes(theme) {
        const album = vm.albumDetails[theme];
